...
static uint8_t RemotePublicKey[LoLaCryptoDefinition::PUBLIC_KEY_SIZE] = { 0x21,0x9B,0xA6,0x2A,0xF0,0x14,0x8A,0x62,0xEB,0x2A,0xF0,0xD1,0xAC,0xB4,0x6E,0x15,0x1B,0x63,0xA7,0xEA,0x99,0xFD,0x1E,0xDD,0x74,0x2F,0xD4,0xB0,0xE1,0x04,0xC5,0x96,0x09,0x65,0x1F,0xAB,0x4F,0xDC,0x75,0x0C };
static uint8_t RemotePrivateKey[LoLaCryptoDefinition::PRIVATE_KEY_SIZE] = { 0x00,0x9E,0x78,0xBA,0x67,0xEA,0x57,0xA9,0xBD,0x4E,0x1A,0x35,0xFB,0xD3,0xA7,0x19,0x29,0x55,0xB9,0xA1,0x3A };
//
...
using TypicalSubGHzRadio = IVirtualPacketDriver::Configuration<25, 50, 250, 5, 100, 20>;
using SlowSingleChannelRadio = IVirtualPacketDriver::Configuration<1, 200, 1000, 50, 1000, 50>;
...
TimedChannelHopper<ChannelHopPeriod, HOP_TEST_PIN, HOP_TEST_PIN_2> HostChannelHop(SchedulerBase);
...
// Link Remote.
#if defined(PRINT_CHANNEL_HOP)
static const bool LogHop = true;
#else
