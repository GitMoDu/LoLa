...
#elif defined(USE_SX1_TRANSCEIVER)
SPIClass SpiTransceiver(SX1_TRANSCEIVER_SPI_CHANNEL);
Sx1Transceiver<SX1_TRANSCEIVER_PIN_CS, SX1_TRANSCEIVER_PIN_BUSY, SX1_TRANSCEIVER_PIN_RST, SX1_TRANSCEIVER_INTERRUPT_PIN> TransceiverDriver(SchedulerBase, &SpiTransceiver);
#else
