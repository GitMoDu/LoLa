...
#define MAX_RADIO_SERVICES_COUNT							20 //
...
#define LOLA_LINK_COLLISION_SLOT_RANGE_MICROS				(uint32_t)(ILOLA_DEFAULT_DUPLEX_PERIOD_MILLIS*4*1000)
...
#define LOLA_LINK_SERVICE_LINKED_CHANNEL_HOP_PERIOD_MILLIS	(uint32_t)(1000) 
#define LOLA_LINK_SERVICE_LINKED_TOKEN_HOP_PERIOD_MILLIS	(uint32_t)(100) 
