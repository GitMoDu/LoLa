#ifndef _SI4463_TRANSCEIVER_433_1000_h
#define _SI4463_TRANSCEIVER_433_1000_h

#include "../Si446xAbstractTransceiver.h"

namespace Si4463_433_1000
{
	struct RadioConfig
	{
		static constexpr uint16_t TRANSCEIVER_ID = 0x4463;

		static constexpr uint32_t BaseFrequency = 433100000;
		...
		static constexpr uint16_t TTRX_SHORT = 948;
		static constexpr uint16_t TTRX_LONG = 1154;
	...
	static constexpr uint8_t SetupConfig[]
	{
		...
		0x0D, 0x11, 0x10, 0x09, 0x00, 0x16, 0x14, 0x00, 0x0F, 0x31, 0x00, 0x00, 0x00, 0x00,
		0x09, 0x11, 0x11, 0x05, 0x00, 0x19, 0xB4, 0x4B, 0x00, 0x00,
		0x0B, 0x11, 0x12, 0x07, 0x00, 0x80, 0x00, 0x30, 0xFF, 0xFF, 0x00, 0x20,
		0x10, 0x11, 0x12, 0x0C, 0x08, 0x2A, 0x01, 0x00, 0x30, 0x30, 0x00, 0x01, 0x10, 0x00, 0x00, 0x20, 0x10,
		...
		0x10, 0x11, 0x20, 0x0C, 0x00, 0x05, 0x00, 0x07, 0x4C, 0x4B, 0x40, 0x01, 0xC9, 0xC3, 0x80, 0x00, 0x14,
		0x05, 0x11, 0x20, 0x01, 0x0C, 0x7B,
		0x0C, 0x11, 0x20, 0x08, 0x18, 0x05, 0x00, 0x08, 0x03, 0x80, 0x00, 0x00, 0x30,
		0x0D, 0x11, 0x20, 0x09, 0x22, 0x00, 0x3C, 0x08, 0x88, 0x89, 0x07, 0xFF, 0x02, 0x02,
		0x0B, 0x11, 0x20, 0x07, 0x2C, 0x00, 0x23, 0xCF, 0xFF, 0x01, 0x12, 0xE0,
		0x05, 0x11, 0x20, 0x01, 0x35, 0xE2,
		0x0D, 0x11, 0x20, 0x09, 0x38, 0x22, 0x07, 0x07, 0x00, 0x1A, 0x06, 0x66, 0x00, 0x27,
		0x0D, 0x11, 0x20, 0x09, 0x42, 0xA4, 0x03, 0xD6, 0x03, 0x00, 0x60, 0x01, 0xF0, 0x30,
		...
		0x0C, 0x11, 0x40, 0x08, 0x00, 0x38, 0x0D, 0xF9, 0x2C, 0x06, 0xD4, 0x20, 0xFE,
		0x00
	};
};

/// <summary>
/// SI4463 433 MHz LoLa Transceiver @ 1000 kbps.
/// 4GFSK, 25 khz separation.
/// </summary>
...
class Si4463Transceiver433Mhz1000kbps final
	: public Si446xAbstractTransceiver<Si4463_433_1000::RadioConfig, pinCS, pinSDN, pinInterrupt>
{
private:
	using Base = Si446xAbstractTransceiver<Si4463_433_1000::RadioConfig, pinCS, pinSDN, pinInterrupt>;

public:
	Si4463Transceiver433Mhz1000kbps(TS::Scheduler& scheduler, SPIClass& spiInstance) : Base(scheduler, spiInstance)
	{
	}
...
protected:
	...
	{
		size = sizeof(Si4463_433_1000::SetupConfig);

		return Si4463_433_1000::SetupConfig;
	}
};
#endif