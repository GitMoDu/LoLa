#ifndef _SI4463_TRANSCEIVER_433_500_h
#define _SI4463_TRANSCEIVER_433_500_h

#include "../Si446xAbstractTransceiver.h"

namespace Si4463_433_500
{
	struct RadioConfig
	{
		...
		static constexpr uint16_t TTRX_SHORT = 1149;
		static constexpr uint16_t TTRX_LONG = 1948;
	...
	static constexpr uint8_t SetupConfig[]
	{
			...
			0x0D, 0x11, 0x10, 0x09, 0x00, 0x0A, 0x14, 0x00, 0x0F, 0x3D, 0x00, 0x00, 0x00, 0x00,
			0x09, 0x11, 0x11, 0x05, 0x00, 0x15, 0xB4, 0x4B, 0x00, 0x00,
			...
			0x10, 0x11, 0x20, 0x0C, 0x00, 0x03, 0x80, 0x07, 0x4C, 0x4B, 0x40, 0x01, 0xC9, 0xC3, 0x80, 0x00, 0x06,
			0x05, 0x11, 0x20, 0x01, 0x0C, 0xD4,
			0x0C, 0x11, 0x20, 0x08, 0x18, 0x01, 0x00, 0x08, 0x03, 0x80, 0x00, 0x00, 0x30,
			0x0D, 0x11, 0x20, 0x09, 0x22, 0x00, 0x3C, 0x08, 0x88, 0x89, 0x07, 0xFF, 0x02, 0x00,
			0x0B, 0x11, 0x20, 0x07, 0x2C, 0x00, 0x23, 0xCF, 0xFF, 0x00, 0xE4, 0xE0,
			0x05, 0x11, 0x20, 0x01, 0x35, 0xE2,
			...
			0x05, 0x11, 0x20, 0x01, 0x51, 0x0A,
			0x10, 0x11, 0x21, 0x0C, 0x00, 0x5B, 0x47, 0x0F, 0xC0, 0x6D, 0x25, 0xF4, 0xDB, 0xD6, 0xDF, 0xEC, 0xF7,
			0x10, 0x11, 0x21, 0x0C, 0x0C, 0xFE, 0x01, 0x15, 0xF0, 0xFF, 0x03, 0x5B, 0x47, 0x0F, 0xC0, 0x6D, 0x25,
			0x10, 0x11, 0x21, 0x0C, 0x18, 0xF4, 0xDB, 0xD6, 0xDF, 0xEC, 0xF7, 0xFE, 0x01, 0x15, 0xF0, 0xFF, 0x03,
...
/// <summary>
/// SI4463 433 MHz LoLa Transceiver @ 500 kbps.
/// </summary>
...
class Si4463Transceiver433Mhz500kbps final
	: public Si446xAbstractTransceiver<Si4463_433_500::RadioConfig, pinCS, pinSDN, pinInterrupt>
{
private:
	using Base = Si446xAbstractTransceiver<Si4463_433_500::RadioConfig, pinCS, pinSDN, pinInterrupt>;

public:
	Si4463Transceiver433Mhz500kbps(TS::Scheduler& scheduler, SPIClass& spiInstance) : Base(scheduler, spiInstance)
	{
	}
...
protected:
	...
	{
		size = sizeof(Si4463_433_500::SetupConfig);

		return Si4463_433_500::SetupConfig;
	}
};
#endif