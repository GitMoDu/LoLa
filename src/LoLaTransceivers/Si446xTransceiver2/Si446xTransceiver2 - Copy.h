...
public:
	...
	void SetupInterrupts(void (*onRadioInterrupt)(void)
		, void (*onDmaReceiveInterrupt)(void) = nullptr
		, void (*onDmaTransmitInterrupt)(void) = nullptr)
	{
		BaseClass::RadioSetup(onRadioInterrupt, onDmaReceiveInterrupt, onDmaTransmitInterrupt);
	}
