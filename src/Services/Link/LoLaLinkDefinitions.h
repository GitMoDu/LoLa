...
#define LOLA_LINK_SERVICE_BROADCAST_PERIOD					(uint32_t)(LOLA_LINK_SERVICE_UNLINK_RESEND_PERIOD*3)

#define LOLA_LINK_SERVICE_CONNECTING_CANCEL_SLEEP_DURATION	LOLA_LINK_SERVICE_KEEP_ALIVE_SEND_PERIOD

#define LOLA_LINK_SERVICE_MAX_BEFORE_CONNECTING_CANCEL		(uint32_t)200 //Typical value is < 200 ms
#define LOLA_LINK_SERVICE_PERIOD_INTERVENTION				(uint32_t)(LOLA_LINK_SERVICE_MAX_BEFORE_DISCONNECT/2)
#define LOLA_LINK_SERVICE_PANIC								(uint32_t)100
