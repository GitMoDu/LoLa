...
#define LOLA_LINK_SERVICE_UNLINK_REMOTE_BACK_OFF_PERIOD		(uint32_t)(10)
...
//Linking packets.
#define LOLA_LINK_SUBHEADER_INFO_SYNC_HOST					0x40
#define LOLA_LINK_SUBHEADER_NTP_REPLY						0x41
