...
#define LOLA_LINK_SERVICE_MAX_BEFORE_CONNECTING_CANCEL		(uint32_t)(LOLA_LINK_SERVICE_BROADCAST_PERIOD*2)
#define LOLA_LINK_SERVICE_CONNECTING_MIN_DURATION			(uint32_t)50
