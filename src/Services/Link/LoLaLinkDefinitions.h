...
#define LOLA_LINK_SERVICE_LINKED_MAX_BEFORE_DISCONNECT		(uint32_t)(300)
#define LOLA_LINK_SERVICE_PERIOD_INTERVENTION				(uint32_t)((LOLA_LINK_SERVICE_LINKED_MAX_BEFORE_DISCONNECT*6)/10)
...
//#define LOLA_LINK_SUBHEADER_LINK_INFO_REPORT				0xF9
