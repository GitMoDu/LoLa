...
#define LOLA_LATENCY_SERVICE_NO_REPLY_TIMEOUT_MILLIS				(LOLA_LATENCY_PING_DATA_POINT_STACK_SIZE*(100 + LOLA_SEND_SERVICE_REPLY_DEFAULT_TIMEOUT_MILLIS+LOLA_LATENCY_SERVICE_SEND_BACK_OFF_DURATION_MILLIS))
