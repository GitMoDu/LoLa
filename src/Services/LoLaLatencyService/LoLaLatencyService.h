...
#define LOLA_LATENCY_SERVICE_SEND_BACK_OFF_DURATION_MILLIS			12
#define LOLA_LATENCY_SERVICE_SEND_FAILED_BACK_OFF_DURATION_MILLIS	50
...
#define LOLA_LATENCY_SERVICE_UNABLE_TO_MEASURE_TIMEOUT_MILLIS		((uint32_t)10000 + (uint32_t)LOLA_LATENCY_SERVICE_NO_REPLY_TIMEOUT_MILLIS)
